...
<table width="95%" border="0" align="center" cellpadding="4" cellspacing="2">
  ...
  <tr> 
    ...
    <td valign="top" rowspan="2"><img src="images/spacer.gif" width="10" height="1" alt="" border="0"></td>
  ...
  <tr> 
    ...
    <td valign="bottom"> <!--- <cfoutput query="common">#HTMLCodeformat(body)#</cfoutput> --->
