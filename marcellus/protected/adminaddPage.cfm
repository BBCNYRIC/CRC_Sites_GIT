...
<!--- if it's a teacher, send them to the add page for teachers --->
<cfif session.auth.authlevel EQ 1>
	<cflocation url="taddpage.cfm" addtoken="No"><cfabort>
</cfif>
...
INSERT INTO contacts(userlogin, userpassword, authlevel, accessgroup, description, rankorder, hidepage, lockHeader)
VALUES (<cfqueryparam value="VOID" cfsqltype="CF_SQL_CHAR">,
		<cfqueryparam value="VOID" cfsqltype="CF_SQL_CHAR">,
		<cfqueryparam value="1" cfsqltype="CF_SQL_INTEGER">,
		<cfif isdefined("FORM.acccode")><cfqueryparam value="#FORM.acccode#" cfsqltype="CF_SQL_INTEGER"><cfelse>0</cfif>,
		...
		<cfqueryparam value="#FORM.lockHeader#" cfsqltype="CF_SQL_CHAR">)
</cfquery>
...
<cfquery datasource="#datasource#">
INSERT INTO pageatt(tid, pppage, pagePassword, newwindow, showDateFrom, showDateTo)
VALUES (<cfoutput query="gettid"><cfqueryparam value="#maxtid#" cfsqltype="CF_SQL_INTEGER"></cfoutput>,
		<cfqueryparam value="#FORM.pppage#" cfsqltype="CF_SQL_CHAR">,
...
<table width="90%" border="0" cellspacing="0" cellpadding="6" class="LL BL RL TL tempeditBGcolor" align="center">
		...
		<tr> 
		  ...
		  <tr> 
            ...
            <td align="left"> <input type="checkbox" name="lockHeader" value="yes"> </td>
          </tr>
		  </cfif>
		  
		  <tr> 
            <td align="right"> Open link in new window: </td>
            <td align="left"> <input type="checkbox" name="newwindow" value="yes"> </td>
          </tr>
...
Stop showing after: <cfinput type="Text" name="showDateTo" value="" validate="date" required="No" size="16" id="showDateTo" placeholder="Click to choose date">
		  ...
		  <tr> 
            ...
            <td align="left"> <cfoutput query="getaccesscats">
					<input type="radio" name="acccode" value="#groupid#" checked> #groupname# <br>
				 </cfoutput> </td>
          </tr>
		  
          <tr> 
            <td>&nbsp;</td>
            <td> <input type="submit" class="gl_submit" name="Submit" value="Add this Page">
			&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="taddPage.cfm">Add a page to your personal account instead</a>
			</td>
          </tr>
        </table>
</cfform>
